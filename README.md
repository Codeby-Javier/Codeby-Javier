<!--
  ...
  Horizontal layout with icons, bilingual switch
-->
...
- **Eduwork (Fullstack Intern)** → API response ↓45%, deployment cycle ↓90%.  
- **AB Prima Net (Web Developer)** → 350+ locations, 3,500+ subscribers, revenue +IDR 40M.

---

## 🏆 Featured Projects
- **MarketPulse ID (Financial Dashboard)** — Portfolio monitoring efficiency +70%.  
- **Website All In One — PT Bina Auto Solusi** — Data accuracy 95%, uptime 99%.  
- **Digitalisasi Koperasi** — Operational efficiency +60%.  
- **BillingPay WiFi** — Scaled to 350+ locations, uptime 98%.  
- **Meeting Assist (AI Tool)** — Documentation time ↓75%, accuracy 92%.
...
## 💼 Pengalaman (Capaian Utama)
- **BRI (Backend Developer)** → Latensi query ↓35%, MTTD ↓40%, MTTR ↓30%, ketersediaan ≥99%.  
- **Bina Auto Solusi (Frontend Developer)** → Kecepatan loading +50%, trafik organik +40%.  
- **ASUS Center (Backend Developer)** → Response time <300ms, waktu proses ↓87.5%, uptime 99.5%.  
- **Eduwork (Fullstack Intern)** → Response API ↓45%, siklus deployment ↓90%.  
- **AB Prima Net (Web Developer)** → 350+ lokasi, 3,500+ pelanggan, revenue +IDR 40M.
